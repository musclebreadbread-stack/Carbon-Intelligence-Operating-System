 ...
 *
 * Korean is the default locale (see `./locales`); every key here carries a `ko`
 * translation so a Korean user never sees a raw English fallback for a known
 * action outcome. `action-message-coverage.test.ts` enforces that.
 *
...
export const SUCCESS_MESSAGES: Readonly<Record<string, MessageEntry>> = {
  ...
  "action.success.setActiveOrganization": { en: "Switched organization.", ko: "조직이 전환되었습니다." },
  ...
  "action.success.commitDataImportJob": { en: "Import job committed.", ko: "가져오기 작업이 커밋되었습니다." },
  ...
  "action.success.rotateFieldEncryption": { en: "Field encryption key rotated.", ko: "필드 암호화 키가 회전되었습니다." },
  "action.success.archiveAuditTrail": { en: "Audit trail archived.", ko: "감사 로그가 보관되었습니다." },
  "action.success.setLocale": { en: "Locale updated.", ko: "언어 설정이 변경되었습니다." },
